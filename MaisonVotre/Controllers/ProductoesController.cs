...
namespace MaisonVotre.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        {
            var productoes = db.Productoes.Include(p => p.Empresas);
        ...
        public ActionResult Create([Bind(Include = "ProductoId,ProductoNombre,ProductPrecio,Imagen,ProductUltimaVenta,ProductExistencia,Productodescripcion,EmpresaId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductoId,ProductoNombre,ProductPrecio,Imagen,ProductUltimaVenta,ProductExistencia,Productodescripcion,EmpresaId")] Producto producto)
        {
            if (ModelState.IsValid)
            {
